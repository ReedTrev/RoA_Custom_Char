...
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 152);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, large_wood_hfx);
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -162);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, xlarge_leaf_hfx);
