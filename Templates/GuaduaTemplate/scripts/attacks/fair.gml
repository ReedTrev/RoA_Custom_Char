...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, large_wood_hfx);
...
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT, small_wood_hfx);
...
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT, xlarge_wood_hfx);
